...
async def test_calendar_integration_sessions_secondary_courses(db_session, tenant_id):
    ...
    await db_session.execute(
        text(
            "INSERT INTO departments (id, tenant_id, name, code) VALUES (:id, :t_id, 'Anatomy Dept', 'ANAT_C_E008')"
        ),
        {"id": dept_id, "t_id": tenant_id},
    )
    prog_id = uuid.uuid4()
    await db_session.execute(
        text(
            "INSERT INTO programs (id, tenant_id, name, code, type, duration_years) VALUES (:id, :t_id, 'MBBS', 'MBBS-CBME-E008', 'professional_phase', 5)"
        ),
        {"id": prog_id, "t_id": tenant_id},
    )
    curr_id = uuid.uuid4()
    await db_session.execute(
        text(
            "INSERT INTO curricula (id, tenant_id, program_id, name, version_code) VALUES (:id, :t_id, :p_id, 'CBME 2023', 'CBME-2023-E008')"
        ),
        {"id": curr_id, "t_id": tenant_id, "p_id": prog_id},
    )
    ...
    await db_session.execute(
        text(
            "INSERT INTO batches (id, tenant_id, academic_year_id, program_id, name, code) VALUES (:id, :t_id, :ay_id, :prog_id, 'MBBS 2026', 'MBBS2026-E008')"
        ),
        {"id": batch_id, "t_id": tenant_id, "ay_id": ay_id, "prog_id": prog_id},
    )
    await db_session.commit()
    ...
    ec_a = EventCourse(
        tenant_id=tenant_id, event_id=event.id, course_id=course_a.id, is_primary=True
    )
    ec_b = EventCourse(
        tenant_id=tenant_id, event_id=event.id, course_id=course_b.id, is_primary=False
    )
...
async def test_cal_e003_bulk_event_generation(db_session, tenant_id):
    ...
    await db_session.execute(
        text(
            "INSERT INTO departments (id, tenant_id, name, code) VALUES (:id, :t_id, 'Anat Dept', 'ANAT_C_E003')"
        ),
        {"id": dept_id, "t_id": tenant_id},
    )
    prog_id = uuid.uuid4()
    await db_session.execute(
        text(
            "INSERT INTO programs (id, tenant_id, name, code, type, duration_years) VALUES (:id, :t_id, 'MBBS', 'MBBS-CBME-E003', 'professional_phase', 5)"
        ),
        {"id": prog_id, "t_id": tenant_id},
    )
    curr_id = uuid.uuid4()
    await db_session.execute(
        text(
            "INSERT INTO curricula (id, tenant_id, program_id, name, version_code) VALUES (:id, :t_id, :p_id, 'CBME 2023', 'CBME-2023-E003')"
        ),
        {"id": curr_id, "t_id": tenant_id, "p_id": prog_id},
    )
    course_id = uuid.uuid4()
    ...
    await db_session.execute(
        text(
            "INSERT INTO batches (id, tenant_id, academic_year_id, program_id, name, code) VALUES (:id, :t_id, :ay_id, :prog_id, 'MBBS 2026', 'MBBS2026-E003')"
        ),
        {"id": batch_id, "t_id": tenant_id, "ay_id": ay_id, "prog_id": prog_id},
    )
    await db_session.commit()
...
async def test_cal_e004_holiday_conflict_warning(db_session, tenant_id):
    ...
    await db_session.execute(
        text(
            "INSERT INTO departments (id, tenant_id, name, code) VALUES (:id, :t_id, 'Anat Dept', 'ANAT_C_E004')"
        ),
        {"id": dept_id, "t_id": tenant_id},
    )
    prog_id = uuid.uuid4()
    await db_session.execute(
        text(
            "INSERT INTO programs (id, tenant_id, name, code, type, duration_years) VALUES (:id, :t_id, 'MBBS', 'MBBS-CBME-E004', 'professional_phase', 5)"
        ),
        {"id": prog_id, "t_id": tenant_id},
    )
    curr_id = uuid.uuid4()
    await db_session.execute(
        text(
            "INSERT INTO curricula (id, tenant_id, program_id, name, version_code) VALUES (:id, :t_id, :p_id, 'CBME 2023', 'CBME-2023-E004')"
        ),
        {"id": curr_id, "t_id": tenant_id, "p_id": prog_id},
    )
    course_id = uuid.uuid4()
    ...
    await db_session.execute(
        text(
            "INSERT INTO batches (id, tenant_id, academic_year_id, program_id, name, code) VALUES (:id, :t_id, :ay_id, :prog_id, 'MBBS 2026', 'MBBS2026-E004')"
        ),
        {"id": batch_id, "t_id": tenant_id, "ay_id": ay_id, "prog_id": prog_id},
    )
    await db_session.commit()
...
async def test_cal_e005_faculty_leave_conflict(db_session, tenant_id):
    ...
    await db_session.execute(
        text(
            "INSERT INTO departments (id, tenant_id, name, code) VALUES (:id, :t_id, 'Anat Dept', 'ANAT_C_E005')"
        ),
        {"id": dept_id, "t_id": tenant_id},
    )
    prog_id = uuid.uuid4()
    await db_session.execute(
        text(
            "INSERT INTO programs (id, tenant_id, name, code, type, duration_years) VALUES (:id, :t_id, 'MBBS', 'MBBS-CBME-E005', 'professional_phase', 5)"
        ),
        {"id": prog_id, "t_id": tenant_id},
    )
    curr_id = uuid.uuid4()
    await db_session.execute(
        text(
            "INSERT INTO curricula (id, tenant_id, program_id, name, version_code) VALUES (:id, :t_id, :p_id, 'CBME 2023', 'CBME-2023-E005')"
        ),
        {"id": curr_id, "t_id": tenant_id, "p_id": prog_id},
    )
    course_id = uuid.uuid4()
    ...
    await db_session.execute(
        text(
            "INSERT INTO batches (id, tenant_id, academic_year_id, program_id, name, code) VALUES (:id, :t_id, :ay_id, :prog_id, 'MBBS 2026', 'MBBS2026-E005')"
        ),
        {"id": batch_id, "t_id": tenant_id, "ay_id": ay_id, "prog_id": prog_id},
    )
    ...
    await db_session.execute(
        text(
            "INSERT INTO users (id, tenant_id, email, full_name, is_active) VALUES (:id, :t_id, :email, 'Faculty Student', true)"
        ),
        {"id": fac_user_id, "t_id": tenant_id, "email": f"fac_stud_{fac_user_id}@test.com"},
    )
    await db_session.execute(
        text(
            "INSERT INTO students (id, tenant_id, user_id, batch_id, roll_number, admission_year, status) VALUES (:id, :t_id, :u_id, :b_id, 'ROLL_FAC_LEAVE', 2024, 'active')"
        ),
        {"id": faculty_id, "t_id": tenant_id, "u_id": fac_user_id, "b_id": batch_id},
    )
    await db_session.execute(
        text(
            "INSERT INTO faculty (id, tenant_id, user_id, department_id, designation, employee_id) VALUES (:id, :t_id, :u_id, :dept_id, 'Professor', 'EMP_FAC_LEAVE')"
        ),
...
async def test_cal_e006_room_double_booking(db_session, tenant_id):
    ...
    await db_session.execute(
        text(
            "INSERT INTO departments (id, tenant_id, name, code) VALUES (:id, :t_id, 'Anat Dept', 'ANAT_C_E006')"
        ),
        {"id": dept_id, "t_id": tenant_id},
    )
    prog_id = uuid.uuid4()
    await db_session.execute(
        text(
            "INSERT INTO programs (id, tenant_id, name, code, type, duration_years) VALUES (:id, :t_id, 'MBBS', 'MBBS-CBME-E006', 'professional_phase', 5)"
        ),
        {"id": prog_id, "t_id": tenant_id},
    )
    curr_id = uuid.uuid4()
    await db_session.execute(
        text(
            "INSERT INTO curricula (id, tenant_id, program_id, name, version_code) VALUES (:id, :t_id, :p_id, 'CBME 2023', 'CBME-2023-E006')"
        ),
        {"id": curr_id, "t_id": tenant_id, "p_id": prog_id},
    )
    course_id = uuid.uuid4()
    ...
    await db_session.execute(
        text(
            "INSERT INTO batches (id, tenant_id, academic_year_id, program_id, name, code) VALUES (:id, :t_id, :ay_id, :prog_id, 'MBBS 2026', 'MBBS2026-E006')"
        ),
        {"id": batch_id, "t_id": tenant_id, "ay_id": ay_id, "prog_id": prog_id},
    )
    await db_session.commit()
...
async def test_cal_e007_phase_boundary_validation(db_session, tenant_id):
    ...
    await db_session.execute(
        text(
            "INSERT INTO departments (id, tenant_id, name, code) VALUES (:id, :t_id, 'Anat Dept', 'ANAT_C_E007')"
        ),
        {"id": dept_id, "t_id": tenant_id},
    )
    prog_id = uuid.uuid4()
    await db_session.execute(
        text(
            "INSERT INTO programs (id, tenant_id, name, code, type, duration_years) VALUES (:id, :t_id, 'MBBS', 'MBBS-CBME-E007', 'professional_phase', 5)"
        ),
        {"id": prog_id, "t_id": tenant_id},
    )
    curr_id = uuid.uuid4()
    await db_session.execute(
        text(
            "INSERT INTO curricula (id, tenant_id, program_id, name, version_code) VALUES (:id, :t_id, :p_id, 'CBME 2023', 'CBME-2023-E007')"
        ),
        {"id": curr_id, "t_id": tenant_id, "p_id": prog_id},
    )
    course_id = uuid.uuid4()
    ...
    await db_session.execute(
        text(
            "INSERT INTO batches (id, tenant_id, academic_year_id, program_id, name, code) VALUES (:id, :t_id, :ay_id, :prog_id, 'MBBS 2026', 'MBBS2026-E007')"
        ),
        {"id": batch_id, "t_id": tenant_id, "ay_id": ay_id, "prog_id": prog_id},
    )
    await db_session.commit()
