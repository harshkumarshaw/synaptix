...
async def test_lesson_plan_integration_service(db_session, tenant_id):
    ...
    await db_session.execute(
        text(
            "INSERT INTO departments (id, tenant_id, name, code) VALUES (:id, :t_id, 'Physiology Dept', 'PHYS_LP')"
        ),
    ...
    await db_session.execute(
        text(
            "INSERT INTO programs (id, tenant_id, name, code, type, duration_years) VALUES (:id, :t_id, 'MBBS', 'MBBS-CBME-LP2', 'professional_phase', 5)"
        ),
    ...
    await db_session.execute(
        text(
            "INSERT INTO curricula (id, tenant_id, program_id, name, version_code) VALUES (:id, :t_id, :p_id, 'CBME 2023', 'CBME-2023-LP2')"
        ),
    ...
    await db_session.execute(
        text(
            "INSERT INTO courses (id, tenant_id, curriculum_id, department_id, name, code, default_attendance_category, subject_code) VALUES (:id, :t_id, :curr_id, :d_id, 'Physiology', 'PHYS-LP-101', 'theory', 'PHYS')"
        ),
