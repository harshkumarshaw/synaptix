...
def upgrade() -> None:
    ...
    op.create_index("idx_academic_years_tenant", "academic_years", ["tenant_id"],
    ...
    op.create_table(
        ...
        sa.Column("type", sa.String(50), nullable=False,
                  comment="professional_phase | semester"),
    ...
    op.create_index("idx_programs_tenant", "programs", ["tenant_id"],
                    postgresql_where=sa.text("deleted_at IS NULL"))
    ...
    op.create_index("idx_curricula_tenant", "curricula", ["tenant_id"],
                    postgresql_where=sa.text("deleted_at IS NULL"))
    op.create_index("idx_curricula_program", "curricula", ["program_id"],
                    postgresql_where=sa.text("deleted_at IS NULL"))
