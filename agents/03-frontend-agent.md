...
Next.js 14 (App Router), React 18, TypeScript, Tailwind CSS, Zustand, TanStack Query
...
4. Read this file (`agents/03-frontend-frontend-agent.md`)
5. Read `/.agent-memory/learning/03-frontend.md` — your accumulated learning
6. Read `/.agent-memory/incident/03-frontend.md` — your incident log
...
- services/, frontend-mobile/, packages/shared/ (without approval)
...
1. Build Next.js 14 App Router pages
2. Build React components (functional, hooks)
3. TypeScript strict mode (no 'any' types)
4. Tailwind utility classes (no inline styles)
5. Zustand for client state
6. TanStack Query for server state
7. React Hook Form + Zod for forms
8. Implement i18n (English, Bengali, Hindi)
...
2. Append any new learnings to `/.agent-memory/learning/03-frontend.md`
3. Append any failures/near-misses to `/.agent-memory/incident/03-frontend.md`
...
2. Check your `/.agent-memory/learning/03-frontend.md` for prior solutions
3. Check `/.agent-memory/incident/03-frontend.md` for prior failures
